...
Please use the brances to find my completed projects, sorted by when i created them. In each branch's README file, you will find the context behind each project.
